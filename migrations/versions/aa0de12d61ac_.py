...
Revision ID: aa0de12d61ac
Revises: 4fc224d90e2a
Create Date: 2019-05-19 23:53:40.156853
...
revision = 'aa0de12d61ac'
down_revision = '4fc224d90e2a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('operautor', sa.String(length=80), nullable=True),
